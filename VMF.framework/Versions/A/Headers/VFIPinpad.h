 ...
 *
 ...
 This command will support VSD mode of encryption. VSD supports 10 DUPKT key slots, indexed from 0 to 9. Optionally the key slot or key index may be specified with E10. Key index defaults to 01 if no index is specified.
 ...
 @param mode EncryptionMode() to set
 @param index Index of DUKPT key. This optional value is in the range of 0 to 9 and only applicable if Encryption Mode = EncryptionMode_VSD. The default value is 1;
 *
