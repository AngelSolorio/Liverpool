...
//payment Data
#define NUMERO_TARJETA      @"noTarjeta"
#define TIPO_TARJETA        @"tipoTarjeta"
#define CODIGO_AUTH         @"ds"
#define MONTO_TARJETA       @"monto"
#define LISTA_PAGOS         @"paymentList"
...
-(void) startParser:(NSData*) data
{
    ...
    paymentCardList=[[NSMutableArray alloc]init];
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict
{
    ...
    else if ([currentElement isEqualToString:LISTA_PAGOS]) {
		card=[[Card alloc]init];
		[paymentCardList addObject:card];
		[card release];
...
- (void)parser:(NSXMLParser *)parser foundCharacters:(NSString *)string
{
    ...
    //----------------------payment cancel data-------------------
    else if ([currentElement isEqualToString:NUMERO_TARJETA]) {
        [card setCardNumber:string];

	}
    else if ([currentElement isEqualToString:TIPO_TARJETA]) {
        [card setCardType:string];
        
	}
    else if ([currentElement isEqualToString:CODIGO_AUTH]) {
        [card setAuthCode:string];
        
	}
    else if ([currentElement isEqualToString:MONTO_TARJETA]) {
        [card setAmountToPay:string];
